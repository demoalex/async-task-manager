...
SECRET_KEY = 'django-insecure-x3u#6fi8cy2nv=1e^b2%1i_$b%q!8s^^v2%y%o0msnobwd5a6+'
SESSION_COOKIE_NAME = 'analytics_sessionid'
...
MIDDLEWARE = [
    ...
    'analytics.middleware.OAuthMiddleware',
]
...
CONN_MAX_AGE = 0
RELE = {
    'APP_NAME': 'djanalytics',
    'SUB_PREFIX': 'djanalytics',
